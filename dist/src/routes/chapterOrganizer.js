...
exports.chapterOrganizerRoutes = void 0;
const express_1 = require("express");
const prisma_1 = require("../lib/prisma");
exports.chapterOrganizerRoutes = (0, express_1.Router)();
// POST /api/chapters/organize - Get AI suggestions for organizing events into chapters
exports.chapterOrganizerRoutes.post('/organize', async (req, res) => {
    try {
...
exports.chapterOrganizerRoutes.post('/apply', async (req, res) => {
    try {
...
exports.chapterOrganizerRoutes.get('/unassigned', async (req, res) => {
    try {
        const events = await prisma_1.prisma.event.findMany({
...
//# sourceMappingURL=chapterOrganizer.js.map